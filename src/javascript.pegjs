...
ReadableFieldStatement
 = field: Identifier __ ":"
   __ body: ReadFieldStatement? __ EOS {
     return {
       type: "ReadableFieldStatement",
       field,
       body
     };
 }
...
JSFieldDefinitionStatement
  =  label:Identifier __ ":"
   __ body:ReadFieldStatement {
      return {
...
DirectiveStatement
 = "#" id: Identifier __ expr: Identifier? __ EOS {
   return {
