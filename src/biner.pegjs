...
ImportStatement
  = ImportKeyword 
  __ keyNames: Identifier 
  __ FromKeyword 
  __ moduleName: Identifier {
      return {
...
DirectiveStatement
  = "#" id: Identifier __ value: Identifier __? EOS {
    return {
...
ConstNameStatement
  = "#" id: Identifier {
    return {
      type: "ConstNameStatement",
      id
    };
  }

ConstStatement
  = ConstNameStatement __ "=" __ value: (Digit) __? EOS {
    return {
      type: "ConstStatement",
      value
    };
